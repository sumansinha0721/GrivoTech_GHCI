<nav class="navbar navbar-default">
	<div class="container" style="width: 97%;">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#" style="font-size: 24px;"> GrivoTech | University Portal
			</a>
		</div>
		<div id="nabvar" class="collapse navbar-collapse pull-right">
			<div style="display: flex; flex-direction: row;">
				<div style="color:#fff; font-size: 24px; margin-right: 1em;">
<?php 
echo htmlentities($_SESSION['collegeName']); ?>
