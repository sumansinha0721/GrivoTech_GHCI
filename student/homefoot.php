		...
		<article class="inner-footer">
			...
			<section class="footer-items">
				...
				<ul>
					...
					<a href="https://www.ap.gov.in/?page_id=60"><li>Education Department, Govt. of Andhra Pradesh</li></a><br>
			...
			<section class="footer-items">
				...
				<ul>
					...
					<li><i class="fa fa-envelope" aria-hidden="true"></i>grivotech@gmail.com</li>
				</ul>
